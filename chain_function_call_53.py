...
# shot
# Functions: 3
# First calls get_coordinates() to get lat and lon of the city and then calls the get_air_data() with these lat and lon to get current air quality data and then plot_air_data()
...
model_name = "smollm2:1.7b-instruct-q4_K_M"  # LLM for dynamic routes # LLM for dynamic routes # qwen2.5:0.5b-instruct  # llama3.2:1b-instruct-q4_K_M # smollm2:1.7b-instruct-q4_K_M
...
# Updated function schema for plot_air_data
...
routes = [
    Route(
        ...
        utterances=[
            "Plot air quality of London",
            "Can you plot air quality data of Delhi?",
            "Kindly plot air quality data of Kolkata",
        ],
        dynamic=True,
        functions=[get_coordinates, get_air_data, plot_air_data],
        function_schemas=[get_coordinates_schema, get_air_data_schema, plot_air_data_schema]
    )
]
...
def create_multi_shot_prompt(prompt: str, route: Route) -> str:
    examples = """
Example 1:
User: Plot air quality of Sydney
Assistant:
...
Result: "Plot saved as Sydney_2024-11-15.png"


Example 2:
User: Plot air quality of New York
Assistant:
Function: get_coordinates
...
Result: "Plot saved as New_York_2024-11-15.png"


Example 3:
User: Can you plot air quality of Delhi?
Assistant:
Function: get_coordinates
...
Result: "Plot saved as Delhi_2024-11-15.png"
