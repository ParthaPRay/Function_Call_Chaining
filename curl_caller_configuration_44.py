# This curl caller code calls the simple functional call xecuted by 'chain_functaion_call_44.py'
# Partha Pratim Ray
# 15 November, 2024
...
prompts_with_two_functions = [
    "Get the air quality of Delhi",
    "Find air quality data of Kolkata",
    "Get air quality of Los Angeles",
    "What is current air quality of Mumbai?",
    "Find air quality of Perth",
    "Get air quality of Pune",
    "What is current air quality of Gangtok?",
    "Find air quality of Hyderabad",
    "What is current air quality of Bhubaneswar?",
    "Find air quality of Bengaluru"
