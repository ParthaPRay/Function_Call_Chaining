# This curl caller code calls the simple functional call xecuted by 'chain_functaion_call_61.py'
# Partha Pratim Ray
# 15 November, 2024
...
prompts_with_two_functions = [
    "Plot air quality of Delhi and measure the plot file size",
    "Can you plot air quality data of Kolkata and tell me the file size?",
    "Could you plot air quality data of Los Angeles and measure the size of the plot file",
    "Plot air quality of Mumbai and measure the plot file size",
    "Can you plot air quality data of Perth and tell me the file size?",
    "Kindly plot air quality data of Pune and measure the size of the plot file",
    "Plot air quality of Gangtok and measure the plot file size",
    "Can you plot air quality data of Hyderabad and tell me the file size?",
    "Kindly plot air quality data of Bhubaneswar and measure the size of the plot file",
    "Do plot air quality data of Bengaluru and measure the size of the plot file"
]
